"""
    This Python file is downloaded from: https://www.dropbox.com/sh/vrux2exqwc9uh7k/AAAR4tlJLScPlkmPruvbrTJQa?dl=0
	See Negar Hassanpour, Russell Greiner. Learning Disentangled Representations for CounterFactual Regression. ICLR, 2020. for details.
"""
...
if __name__ == "__main__":
	...
	which_benchmark = '' #str(mA)+'_'+str(mB)+'_'+str(mC)
...
##################################################################
	data_path = storage_path+which_benchmark
